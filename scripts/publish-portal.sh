...
- Adds first-draft runtime upgrade effects for bonus damage, crits, bounce, double shots, XP gain, Range ranks, fire, electric arcs, explosive splash, passive repair, and vampiric healing.
