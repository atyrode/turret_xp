...
local gui = {
  ...
  focused_status = prefix .. "focused-status",
  focused_status_title = prefix .. "focused-status-title",
  focused_status_subtitle = prefix .. "focused-status-subtitle",
  focused_status_xp = prefix .. "focused-status-xp",
  focused_status_points = prefix .. "focused-status-points",
  focused_status_role = prefix .. "focused-status-role",
  focused_status_build = prefix .. "focused-status-build",
  focused_status_actions = prefix .. "focused-status-actions",
  focused_nav = prefix .. "focused-nav",
  ...
  empty_source_nav = prefix .. "empty-source-nav",
...
layout.panel_width = layout.focused_panel_width
