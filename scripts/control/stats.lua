...
function get_repair_base_per_second(state, entity)
  return get_base_rank(state, "repair")
    * REPAIR_MAX_HEALTH_FRACTION_PER_RANK
    * get_repair_reference_health(state, entity)
end
...
function get_damage_resistance_fraction(state)
  return math.min(RESISTANCE_MAX, (get_base_rank(state, "resistance") * RESISTANCE_PER_RANK) + get_sub_specialization_flat_bonus(state, "resistance_flat"))
end
...
function get_crit_chance_fraction(state)
  return apply_luck_to_chance(state, (get_base_rank(state, "crit_chance") * 0.0025) + get_sub_specialization_flat_bonus(state, "crit_chance_flat"))
end

function get_double_shot_chance(state)
  return apply_luck_to_chance(state, (get_augment_rank(state, "double_shot") * 0.04) + get_sub_specialization_flat_bonus(state, "double_shot_chance_flat"))
end
