  ...
  turret_xp_test_register_methods(turret_xp_test_remote_methods, {
    ...
    focused_gui_contract = function(entity, view)
      ...
      local summary = {
        ...
        has_progression_scroll = find_gui_element(root, GUI.focused_progression_scroll) ~= nil,
        has_stats_view = find_gui_element(root, GUI.focused_stats) ~= nil,
        has_stats_table = find_gui_element(root, GUI.focused_stats_table) ~= nil,
        has_automation_view = find_gui_element(root, GUI.focused_automation) ~= nil,
        has_automation_controls = find_gui_element(root, GUI.core_build_controls) ~= nil,
        has_label_controls = find_gui_element(root, GUI.core_label_controls) ~= nil,
