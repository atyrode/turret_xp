...
is_validation_infra_path() {
  case "$1" in
    .github/workflows/*|.gitignore|compose.yaml|tools/lua/*|scripts/check.sh|scripts/check-lua-file-discovery.sh|scripts/format-lua.sh|scripts/install-git-hooks.sh|scripts/lint-lua.sh|scripts/lua-files.sh|scripts/git-hooks/*|scripts/package.py|scripts/package.sh|scripts/release-preflight.sh|scripts/release.sh|scripts/publish-mod-portal-release.sh|scripts/test-headless.sh|scripts/download-mod-dependencies.py)
      return 0
      ;;
  esac
...
is_lua_validation_path() {
  case "$1" in
    *.lua|.gitignore|.luacheckrc|.stylua.toml|compose.yaml|tools/lua/*|scripts/check-lua-file-discovery.sh|scripts/format-lua.sh|scripts/lint-lua.sh|scripts/lua-files.sh)
      return 0
      ;;
  esac
