...
- Keep automation explicit and non-magical: presets can be selected, applied once, or left on Auto, but they should not silently overwrite manual specialization, sub-specialization, or element identity choices that conflict with the preset.
