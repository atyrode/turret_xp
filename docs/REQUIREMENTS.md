...
- Show installed-core Build mode controls with Enter/Exit, target summary, Follow build in live mode, finite planned ranks, loop priorities, and clear visual tinting while previewing a build.
