...
- [REQUIREMENTS.md](REQUIREMENTS.md): user-visible behavior and release requirements.
...
- [PROGRESSION_DESIGN.md](PROGRESSION_DESIGN.md): long-term XP, evolution, perk, material-gate, element-combo, and infinite-scaling direction.
- [DEVELOPMENT_STEPS.md](DEVELOPMENT_STEPS.md): working checklist.
- [PLAYTEST.md](PLAYTEST.md): install and report-back checklist.
