...
- Installed-core naming and floating-label controls now live in `scripts/control/gui/core_label_controls.lua`, including the label-color swatch/trigger row and level-suffix checkbox.
