...
- Evolution base-upgrade and augment rows now share one rank-allocation row builder with explicit icon, detail, value, and stepper widths derived from the full-width Evolution viewport.
