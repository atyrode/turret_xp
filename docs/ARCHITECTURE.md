...
- `on_player_setup_blueprint`: writes Turret XP setup policy tags for gun turrets so blueprinted/copy-built empty turrets can request a core and inherit label/automation setup without cloning the source core profile.
...
- `on_entity_settings_pasted`: copies Turret XP setup policy between gun turrets without copying XP/history/name-bearing profile state.
