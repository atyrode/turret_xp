...
local function run_shield_test(surface)
  ...
  assert_eq(summary.shield_bar_segment_count, 9, "shield bar should render as nine segmented cells")
  ...
  assert_eq(summary.shield_bar_segment_count, 9, "empty shield should keep the segmented shield bar visible")
