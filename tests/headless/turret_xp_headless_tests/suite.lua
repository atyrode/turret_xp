...
local runtime_pressure_tests = require("runtime_pressure_tests")
...
local function run_immediate_tests()
  ...
  combat_tests.run_combat_xp_multiplier_test(surface)
  combat_tests.run_asteroid_xp_balance_test(surface)
  ...
  automation_tests.run_automation_preset_test(surface)
  ...
  combat_tests.run_veteran_training_xp_gain_test(surface)
