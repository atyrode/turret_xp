...
function tests.run_build_mode_planning_test(surface)
  ...
  assert_eq(gui.build_controls_type, "flow", "Build mode controls should render directly inside the shared Build panel")
  ...
  gui = call("installed_gui_contract", turret)
  assert_eq(gui.build_controls_type, "flow", "re-entered Build mode should render directly inside the shared Build panel")
